...
const benefits = [
  {
    ...
    text: "Search and filter without digging through crowded menus.",
  },
  {
    icon: ShieldCheck,
    title: "Clear information",
    text: "See pricing and availability before choosing a product.",
  },
  {
    icon: MessageCircle,
    title: "Simple ordering",
    text: "Create your order and continue with the store through chat.",
  },
];
              ...
              <AnimatedHero
                ...
                description={
                  <p className="mt-4 max-w-xl text-base leading-7 text-muted-foreground">
                    Browse practical vitamins, nutrition, and personal-care
                    essentials with clear pricing and simple chat ordering.
                  </p>
                }
              >
                <div className="mt-5 flex flex-wrap items-center gap-x-5 gap-y-2 text-sm font-medium text-muted-foreground">
                  ...
                  <span className="flex items-center gap-1.5">
                    <ShoppingBag className="size-4 text-primary" /> Clear stock
                    status
                  </span>
                </div>
              </AnimatedHero>
              ...
              <div className="relative lg:pl-5">
                <div className="rounded-xl border border-primary/20 bg-card p-6 shadow-raised sm:p-7">
                  ...
                  <p className="mt-2 text-xl font-semibold leading-snug">
                    Build your cart, then finish your order directly with the
                    store.
                  </p>
                  <Link
                    href="/products"
                    className="mt-6 inline-flex h-11 w-full items-center justify-center gap-2 rounded-md bg-primary px-5 text-base font-semibold text-primary-foreground shadow-card transition-[background-color,box-shadow] hover:bg-primary-hover hover:shadow-raised sm:w-auto"
                  >
                    Go to Store <ArrowRight className="size-4" />
                  </Link>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="text-sm font-semibold text-primary">
                Shopping should feel straightforward
              </p>
              <h2 className="font-heading mt-1 text-xl font-semibold tracking-tight sm:text-2xl">
                Choose your essentials now. Confirm the details in chat.
              </h2>
            </div>
            <Link
              href="/products"
              className="inline-flex h-11 w-full shrink-0 items-center justify-center gap-2 rounded-md bg-primary px-5 text-base font-semibold text-primary-foreground shadow-card transition-[background-color,box-shadow] hover:bg-primary-hover hover:shadow-raised sm:w-auto"
            >
